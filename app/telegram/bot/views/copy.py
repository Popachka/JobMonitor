...
def build_resume_scope_text() -> str:
    return (
        "Что бот учитывает при разборе резюме:\n"
        "• направление и специализацию\n"
        "• основной стек и ключевые технологии\n"
        "• зарплатный ориентир и формат работы, если они указаны\n\n"
        "Если в резюме несколько направлений или стеков, бот сохранит их в профиль."
    )
